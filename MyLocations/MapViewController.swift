...
//                  print("Yooooooooo! Insert", dictionary[NSInsertedObjectsKey])
//                  print("Yooooooooo! Update",dictionary[NSUpdatedObjectsKey])
//                  print("Yooooooooo! Delete",dictionary[NSDeletedObjectsKey])
                }
...
//        let alert = UIAlertController(title: "YO!!", message: ":)", preferredStyle: .alert)
